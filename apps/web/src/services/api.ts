...
export const createTicket = (data: ApiData) => api.post("/tickets", data);
export const updateTicket = (id: string, data: ApiData) =>
  api.patch(`/tickets/${id}`, data);
export const deleteTicket = (id: string) => api.delete(`/tickets/${id}`);
export const deleteTicketAttachment = (id: string, attachmentId: string) =>
